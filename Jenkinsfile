pipeline {
    ...
    environment {
        GITHUB_URL = 'https://github.com/learytl/metallb-deploy.git'  // <---- Change this to match your cloned repository
        KUBECONFIG = credentials('learytl-225')   // <---- Change this to match your kubernetes cluster credentials
    }
